            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Actualizar Material Minero</a></li>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-4">
                                <button type="submit" class="btn btn-warning btn-lg">Agregar Material</button>
                            </div>
                        </div>
                        <br>
