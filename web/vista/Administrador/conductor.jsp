        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Módulo de Conductor</h1>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-md-4">
                                    <button type="submit" class="btn btn-warning btn-lg" href="#" data-toggle="modal" data-target="#myModal">Agregar Conductor</button>
                                </div>
                            </div>
                            ...
                            <table id="example" class="table table-striped table-bordered table-responsive" style="width:100%">
                                ...
                                <tbody>
                                    <%
                                        ArrayList<String> lista = faca.obtenerDatosConductor();
                                    ...
                                    <tr>
                                        ...
                                        <td> <%=dato2[4]%> </td>
                                        <td> <%=dato2[10]%> </td>
                                        <td><input type="button" class="btn btn-success" name="btnModificar" value="Editar" onclick="location.href = 'editarDatosConductor.jsp?idConductor=<%=dato2[0]%>'"> </td>
                                        <td><input type="button" class="btn btn-danger" name="btnEliminar" value="Eliminar" onclick="location.href = '../../ServletRegistroConductor?idConductor=<%=dato2[0]%>&&accion=eliminar'"> </td>
                                    </tr>
                            ...
                            <div id="Docente-Administrativo" class="marcoSeleccionado">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control"  name="TipoDocumentoCon" required="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" placeholder="Numero de Documento" name="numeroCedulaCon" required="" minlength="7" maxlength="10">
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" placeholder="Telefono" name="telefonoCon" required="" minlength="7" maxlength="10">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="NombresCon" placeholder="Nombres" required="" onkeypress="return soloLetras(event)">
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="ApellidosCon" placeholder="Apellidos" required="" onkeypress="return soloLetras(event)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="input-group">
                                                <input type="email" class="form-control" placeholder="Correo Electronico" name="emailCon" aria-describedby="basic-addon2" required="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <input type="text" class="form-control" placeholder="Dirección" name="direccionCon" required="">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-lg-6">
                                            <select class="form-control"  name="TipoSexoCon" required="">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" class="form-control" placeholder="Edad" name="edadCon" min="18" max="80" required="">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Licencia de conducción:</label>
                                        <div class="col-lg-8">
                                            <select class="form-control"  name="licenciaEstado" required="">
                                                <option value="">Seleccione</option>
                                    ...
                                    <button type="submit" class="btn btn-primary" name="accion" value="agregarCon">Registrar</button>
                                </div>
